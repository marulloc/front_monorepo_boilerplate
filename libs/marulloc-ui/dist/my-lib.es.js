  ...
  return ct || (ct = 1, function(O, y) {
    process.env.NODE_ENV !== "production" && function() {
      ...
      function Er(e, r, a) {
        ...
        var o, i = h({}, e.props), p = e.key, l = e.ref, v = e._self, E = e._source, P = e._owner;
        if (r != null) {
      ...
      function _e(e, r, a, o, i) {
        ...
        if (l) {
          var v = e, E = i(v), P = o === "" ? tr + Ae(v, 0) : o;
          if (Fe(E)) {
            var A = "";
            P != null && (A = ve(P) + "/"), _e(E, r, A, "", function(Mt) {
              return Mt;
            });
          } else
...
`), E = o.stack.split(`
`), P = v.length - 1, A = E.length - 1; P >= 1 && A >= 0 && v[P] !== E[A]; )
              A--;
            for (; P >= 1 && A >= 0; P--, A--)
              if (v[P] !== E[A]) {
                if (P !== 1 || A !== 1)
...
function zt() {
  if (lt)
    return He;
  lt = 1;
  var O = pt(), y = Symbol.for("react.element"), Ee = Symbol.for("react.fragment"), X = Object.prototype.hasOwnProperty, de = O.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, re = { key: !0, ref: !0, __self: !0, __source: !0 };
  function te(Q, L, Z) {
...
const Ht = Nr.jsx, Gt = ({ children: O }) => /* @__PURE__ */ Ht("button", { onClick: () => alert("Click!!"), children: O || "Button" });
export {
  Gt as TestButton
};
